    ...
    , m_pointSizeDefault(9)
{
    ...
    setCustomStyle("AdobePhotoshopLightGray");  // hetao 设置默认ribbon风格为AdobePhotoshopLightGray
...
QIcon DemoRibbonWindow::createIcon(ImagesId id, bool onlyLarge)
{
    ...
    // hetao Icon
    case mmImage_Open:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mmImage_Open.png")));
        break;
    case ImageJinzita:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mJinZiTa.png")));
        break;
    case ImageCut:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mCutImage.png")));
        break;
    case ImageLashen:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mLaShen.png")));
        break;
    case ImageLvbo:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mLvBo.png")));
        break;
    case ImageZhifangtu:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mZhiFangTu.png")));
        break;
    case ImageZengqiang:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mZengQiang.png")));
        break;

    case rgbDetect:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mrgbDetect.png")));
        break;
    case sarDetect:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/msarDetect.png")));
        break;
    case rgbsarBianshi:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mrgbsarBianshi.png")));
        break;
    case rgbsarDetect:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mrgbsarDetect.png")));
        break;
    case rgbirDetect:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mrgbirDetect.png")));
        break;
    case rgbsarirDetect:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mrgbsarirDetect.png")));
        break;
    case JinjingLoc:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mJinjingloc.png")));
        break;
    case UAVLoc:
        icon.addPixmap(QPixmap(QStringLiteral(":/QtGis/images/res/mUAVLoc.png")));
        break;
